...
// microsserviço (auth, catalog, table, order, whatsapp) e no api-gateway.
    ...
    public static Set<String> derivar(Set<String> permissoes) {
        ...
        for (String p : permissoes) {
            switch (p) {
                ...
                // DASHBOARD, CARDAPIO, MESAS, USUARIOS, FINANCEIRO, SUPORTE,
                // WHATSAPP_*, CONFIG_* — todos itens de administração.
