...
public class PedidoController {
    ...
    public ResponseEntity<PedidoResponse> preparando(
            @RequestHeader("X-Restaurante-Id") Long restauranteId,
            @RequestHeader(value = "X-User-Id", required = false) Long cozinheiroId,
            @RequestHeader(value = "X-User-Nome", required = false) String cozinheiroNome,
            @PathVariable Long id) {
        return ResponseEntity.ok(pedidoService.marcarPreparando(restauranteId, id, cozinheiroId, cozinheiroNome));
    }
