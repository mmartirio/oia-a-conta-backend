package com.oiaaconta.order.config;

import com.oiaaconta.order.security.ModalidadeOperacaoInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public WebConfig(@Lazy ModalidadeOperacaoInterceptor modalidadeOperacaoInterceptor) {
        this.modalidadeOperacaoInterceptor = modalidadeOperacaoInterceptor;
    }

    @Override
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(modalidadeOperacaoInterceptor)
            .addPathPatterns("/api/mesas/**", "/api/comandas/**", "/api/entregas/**");
    }
}
